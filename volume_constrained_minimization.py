...
def constrained_minimization(Coordinate_file, Program, molecules_in_coord=1, min_RMS_gradient=1e-04,
    ...
    output = scipy.optimize.minimize(Return_U_from_Aniso_Expand, cm_0, (Coordinate_file,
    ...
    Ex.Expand_Structure(Coordinate_file, Program, 'lattice_parameters', 4, 'constV_minimize',
                        min_RMS_gradient, dlattice_parameters=dlattice_parameters, Parameter_file=Parameter_file)
